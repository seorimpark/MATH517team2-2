...
dataMod %>% relocate(Rainfed,Trees,vegetation,ShrubArea)

corr = cor(dataMod, method = "spearman")
corrplot(corr, method = "color")
```

```{r, echo = FALSE}
colnames(dataMod)
#dataMod[c(dataMod$Rainfed, dataMod$Trees, dataMod$vegetation,dataMod$FloadArea,dataMod$MosaicC,dataMod$MosaicVege,dataMod$)]

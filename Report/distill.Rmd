...
FindCorForLC <- function (x,methode,threshold){
  ...
  for (y in 1:10){
    ...
    if (c > threshold | c < -threshold){
      ...
      correlations = c(correlations, -2)
    }
  }
  return(correlations)
}
corr1 = FindCorForLC(1,"pearson",0.6)
print ("Important correlations for the land cover variable number 1: ",  corr1 )
corr2 = FindCorForLC(2,"pearson",0.6)
print ("Important correlations for the land cover variable number 2: ",  corr2 )
corr3 = FindCorForLC(3,"pearson",0.6)
print ("Important correlations for the land cover variable number 3: ",  corr3 )
corr4 =FindCorForLC(4,"pearson",0.6)
print ("Important correlations for the land cover variable number 4: ",  corr4 )
corr5 =FindCorForLC(5,"pearson",0.6)
print ("Important correlations for the land cover variable number 5: ",  corr5 )
corr6 =FindCorForLC(6,"pearson",0.6)
print ("Important correlations for the land cover variable number 6: ",  corr6 )
corr7 =FindCorForLC(7,"pearson",0.6)
print ("Important correlations for the land cover variable number 7: ",  corr7 )
corr8 =FindCorForLC(8,"pearson",0.6)
print ("Important correlations for the land cover variable number 8: ",  corr8 )
corr9 =FindCorForLC(9,"pearson",0.6)
print ("Important correlations for the land cover variable number 9: ",  corr9 )
corr10 =FindCorForLC(10,"pearson",0.6)
print ("Important correlations for the land cover variable number 10: ",  corr10 )
corr11 =FindCorForLC(11,"pearson",0.6)
print ("Important correlations for the land cover variable number 11: ",  corr11 )
corr12 =FindCorForLC(12,"pearson",0.6)
print ("Important correlations for the land cover variable number 12: ",  corr12 )
corr13 =FindCorForLC(13,"pearson",0.6)
print ("Important correlations for the land cover variable number 13: ",  corr13 )
corr14 =FindCorForLC(14,"pearson",0.6)
print ("Important correlations for the land cover variable number 14: ",  corr14 )
corr15 =FindCorForLC(15,"pearson",0.6)
print ("Important correlations for the land cover variable number 15: ",  corr15 )
corr16 =FindCorForLC(16,"pearson",0.6)
print ("Important correlations for the land cover variable number 16: ",  corr16 )
corr17 =FindCorForLC(17,"pearson",0.6)
print ("Important correlations for the land cover variable number 17: ",  corr17 )
corr18 =FindCorForLC(18,"pearson",0.6)
print ("Important correlations for the land cover variable number 18: ",  corr18 )
```

...
We will then proceed with the analysis of the number of fires. To do so,the analysis of the land covers and meteorological parameters will be conducted. After noticing that the correlation between parameters was low, so we used subsets and performed a quantile regression. 
...
We remark that most of the values are close to 0 and because of the outliers we can't see the distribution very good. So we filter the outliers to have a better view of the distrubution 
...
Most of the plots have a distribution that can make this of Poisson distrubtion, or power laws in certain case. 
